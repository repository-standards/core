...
silently do it (scope creep) and do not lose it (evaporation). File it in `backlog.md`.
...
2. **De-duplicate.** Scan `backlog.md`; if the item (or a superset of it) is already
