...
description: Convert tasks.md into GitHub issues - upstream's own bridge; the standard's tracker posture (ADR-010) remains the default (based on github/spec-kit v0.13.2)
---
