...
description: Run the clarify loop on a spec: propose answers, record deferrals in ## Clarifications, drive to zero open markers (based on github/spec-kit v0.13.2, patched)
---
