...
| **2. Decisions in code** | Walk the [decision catalog](decision-records/catalog.md): which forks are decided / undecided / decided **inconsistently** | Every contestable fork has an ADR/BDR; the rest are conscious conventions | Retroactive ADR/BDR for decided-but-unrecorded; backlog item for each undecided fork |
