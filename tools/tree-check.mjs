...
// thirteen bumps it did not happen - 32 commits between the 1.0.0 and 1.0.13 releases carry
...
// a section describing it. The trailing non-digit matters: without it, VERSION 1.0.1 is
// satisfied by `## 1.0.13`.
