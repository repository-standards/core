...
// the current version somewhere AND the previous one somewhere else. "v1.0.13 appears"
// was true while four other places on the same page still read v1.0.12, so the check
