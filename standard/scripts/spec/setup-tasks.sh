...
# The clarify-gate call below (standard ADR-010) is this standard's addition; the "Run /spec-*" hints
# and template-stack paths are adapted from spec-kit's .specify/ layout (standard ADR-014).
