...
Spec-Kit-compatible extensions for the capability-spec model. Implement as skills,
commands, or Spec Kit presets - choose the mechanism per repo after inspecting the
installed Spec Kit version, and reuse native Spec Kit behavior (clarify, plan,
tasks, analyze, converge) instead of reimplementing it.
