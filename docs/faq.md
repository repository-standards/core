...
can point at" as open work. The standard is at 1.0.0, its first stable release, and that release is
the first one tagged - everything before it resolved to the default branch. What you can check today is the machinery: every guard in this repo is
