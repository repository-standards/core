...
claiming to be agent-operable should survive. This project failed **51** of them at least once and has fixed-and-re-verified **59** so far; the rest are logged as open (which includes any case where an attempted fix
