...
claiming to be agent-operable should survive. This project failed **57** of them at least once and has fixed-and-re-verified **54** so far; the rest are logged as open (which includes any case where an attempted fix
