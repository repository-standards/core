...
| Observations recorded | **198** across 11 rounds (2026-08-03, 2026-08-04, 2026-08-06-a-wave6, 2026-08-06-b-field1, 2026-08-06-c-planning-loop, 2026-08-06-d-adr032, 2026-08-06-e-shape08, 2026-08-06-f-upd, 2026-08-06-g-specdec, 2026-08-06-h-gate22, 2026-08-06-i-doc12) |
| Targets assessed | **107** (104 real repositories, 2 synthetic fixtures) |
| Verdicts | 103 pass, 90 fail, 2 not-applicable, 3 partial |
| Failures found | **165** - **86 fixed and re-verified** (across 23 merged pull requests), **79 still open right now** (of which 2 were attempted and a re-run found the fix did not fully hold), logged and named below, not hidden; 11 earlier fails superseded by a later re-run and no longer counted open |
