...
| Observations recorded | **214** across 9 rounds (2026-08-03, 2026-08-04, 2026-08-06-a-wave6, 2026-08-06-b-field1, 2026-08-06-c-planning-loop, 2026-08-06-d-adr032, 2026-08-06-e-shape08, 2026-08-06-f-upd, 2026-08-06-x-tail) |
| Targets assessed | **107** (104 real repositories, 2 synthetic fixtures) |
| Verdicts | 112 pass, 94 fail, 1 not-applicable, 7 partial |
| Failures found | **153** - **87 fixed and re-verified** (across 21 merged pull requests), **66 still open right now** (of which 2 were attempted and a re-run found the fix did not fully hold), logged and named below, not hidden; 28 earlier fails superseded by a later re-run and no longer counted open |
