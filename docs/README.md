...
| [facts.json](facts.json) | the facts this repo restates on more than one surface, each with its source - `scripts/facts-check.mjs` fails when a restatement stops agreeing |
