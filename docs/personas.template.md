...
> See [ADR-006](decision-records/adr/ADR-006-personas-are-a-validation-gate.md).
...
- **Reviewed at the PO stage** of every capability (see `ways-of-working.md`) - the spec
