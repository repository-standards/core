...
The decision checklist lists "target personas" as a product decision to record. (A
...
personas verify behavior against a user. Builds on the decision checklist (target personas =
